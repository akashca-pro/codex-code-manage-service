...
interface Config {
    REDIS_URL : string;
    SERVICE_NAME : string;
    GRPC_CODE_MANAGE_SERVICE_SERVER_URL : string;
    CODE_MANAGE_SERVICE_METRICS_PORT : number;
    ...
    KAFKA_CODE_MANAGE_SERVICE_CLIENT_ID : string;
    KAFKA_BROKERS : string;
    KAFKA_CODE_MANAGE_SERVICE_GROUP_ID : string;
...
export const config : Config = {
    ...
    GRPC_CODE_MANAGE_SERVICE_SERVER_URL : process.env.GRPC_CODE_MANAGE_SERVICE_SERVER_URL!,
    CODE_MANAGE_SERVICE_METRICS_PORT : Number(process.env.CODE_MANAGE_SERVICE_METRICS_PORT)!,
    SERVICE_NAME : "CODE_MANAGE_SERVICE",
    SUBMISSION_DETAILS_CACHE_EXPIRY : Number(process.env.SUBMISSION_DETAILS_CACHE_EXPIRY)!,
    ...
    KAFKA_CODE_MANAGE_SERVICE_CLIENT_ID : process.env.KAFKA_CODE_MANAGE_SERVICE_CLIENT_ID!,
    KAFKA_BROKERS : process.env.KAFKA_BROKERS!,
    KAFKA_CODE_MANAGE_SERVICE_GROUP_ID : process.env.KAFKA_CODE_MANAGE_SERVICE_GROUP_ID!,
